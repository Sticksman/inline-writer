...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field admins on 'Canon'
        db.create_table('artillery_canon_admins', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('canon', models.ForeignKey(orm['artillery.canon'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('artillery_canon_admins', ['canon_id', 'user_id'])

        # Adding field 'Story.canon'
        db.add_column('artillery_story', 'canon',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['artillery.Canon']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Subscription'
        db.delete_table('artillery_subscription')

        # Deleting model 'Canon'
        db.delete_table('artillery_canon')

        # Removing M2M table for field admins on 'Canon'
        db.delete_table('artillery_canon_admins')
